...
const ProductosModel = {
    ...
    //Ojo: la subquery del WHERE ya filtra por color. NO añadimos LEFT JOIN
    //a producto_color/color porque eso duplica filas si un producto tiene
    //varios colores (cada producto saldria N veces, una por color asociado).
    ...
    //Mismo razonamiento que en obtenerPorColor: subquery + sin LEFT JOIN extra
    //para evitar duplicados cuando un producto tiene varios aromas.
