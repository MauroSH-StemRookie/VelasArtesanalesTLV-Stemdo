...
async function request(endpoint, options = {}) {
  ...
  if (!res.ok) throw new Error(data.error || data.mensaje || "Error en la peticion");
  return data;
}
...
export const productosAPI = {
  ...
  create: (producto) => request("/productos", { method: "POST", body: JSON.stringify(producto) }),
  update: (id, producto) => request(`/productos/${id}`, { method: "PUT", body: JSON.stringify(producto) }),
...
export const categoriaAPI = {
  ...
  create: (datos) => request("/categoria", { method: "POST", body: JSON.stringify(datos) }),
  update: (id, datos) => request(`/categoria/${id}`, { method: "PUT", body: JSON.stringify(datos) }),
...
export const aromaAPI = {
  ...
  create: (datos) => request("/aroma", { method: "POST", body: JSON.stringify(datos) }),
  update: (id, datos) => request(`/aroma/${id}`, { method: "PUT", body: JSON.stringify(datos) }),
...
export const colorAPI = {
  ...
  create: (datos) => request("/color", { method: "POST", body: JSON.stringify(datos) }),
  update: (id, datos) => request(`/color/${id}`, { method: "PUT", body: JSON.stringify(datos) }),
...
export const pedidosAPI = {
  ...
  create: (pedido) => request("/pedidos", { method: "POST", body: JSON.stringify(pedido) }),
};
