  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container detail-modal" onClick={e => e.stopPropagation()}>
        ...
        {/* Error */}
        {error && !loading && (
          <div className="auth-error" style={{ margin: '1.5rem' }}>{error}</div>
        )}
          ...
          <div className="detail-content">
            ...
            <div className="detail-info">
              ...
              <div className="detail-price-row">
                ...
                {enOferta && (
                  <span className="detail-price-old">{precio.toFixed(2)} €</span>
                )}
              </div>
              ...
              <div className="detail-add-row">
                ...
                >
                  <span>{product.stock === 0 ? 'Sin stock' : 'Añadir al carrito'}</span>
                  <IconCart />
                </button>
              </div>

              {added && (
                <p className="detail-added-msg">✓ Producto añadido al carrito</p>
              )}
