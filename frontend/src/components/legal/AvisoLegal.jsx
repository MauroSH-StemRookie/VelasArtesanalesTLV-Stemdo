...
export default function AvisoLegal() {
  ...
  return (
    <div className="legal-page">
      ...
      <p>
        Aretsanas de Velas se reserva la facultad de modificar, en cualquier
        momento, y sin aviso previo, la preentación y configuración del Sitio
        ...
        Aretsanas de Velas pueda interrumpir, desactivar y/o cancelar cualquiera
      ...
      <p>
        ...
        Aretsanas de Velas, como los comentarios y/o espacios de blogging,
      ...
      <p>
        Aretsanas de Velas se reserva el derecho de retirar todos aquellos
        comentarios y aportaciones que vulneren la ley, el respeto a la dignidad
        de la persona, que sean discriminatorios, xenófobos, racistas,
        pornográficos, spamming, que atenten contra la juventud o la infancia,
        el orden o la seguridad pública o que, a su juicio, no resultaran
        adecuados para su publicación.
      </p>

      <p>
        En cualquier caso, Aretsanas de Velas no será responsable de las
      ...
      <p>
        ...
        relación de carácter comercial entre Aretsanas de Velas y el Usuario.
      </p>

      <p>
        El Usuario declara ser mayor de edad y disponer de la capacidad jurídica
        suficiente para vincularse por las presentes Condiciones. Por lo tanto,
        este Sitio Web de Aretsanas de Velas no se dirige a menores de edad.
        Aretsanas de Velas declina cualquier responsabilidad por el
        incumplimiento de este requisito.
      </p>

      <p>
        El Sitio Web está dirigido principalmente a Usuarios residentes en
        España. Aretsanas de Velas no asegura que el Sitio Web cumpla con
        legislaciones de otros países, ya sea total o parcialmente. Si el
        Usuario reside o tiene su domiciliado en otro lugar y decide acceder y/o
        navegar en el Sitio Web lo hará bajo su propia responsabilidad, deberá
        asegurarse de que tal acceso y navegación cumple con la legislación
        local que le es aplicable, no asumiendo Aretsanas de Velas
      ...
      <p>
        Aretsanas de Velas no garantiza la continuidad, disponibilidad y
        utilidad del Sitio Web, ni de los Contenidos o Servicios. Aretsanas de
        Velas hará todo lo posible por el buen funcionamiento del Sitio Web, sin
      ...
      <p>
        ...
        ningún caso Aretsanas de Velas será responsable por las pérdidas, daños
        o perjuicios de cualquier tipo que surjan por el acceso, navegación y el
      ...
      <p>
        Aretsanas de Velas tampoco se hace responsable de los daños que pudiesen
      ...
      <p>
        Se informa que el Sitio Web de Aretsanas de Velas pone o puede poner a
      ...
      <p>
        ...
        de los mismos. Aretsanas de Velas no ofrece ni comercializa por sí ni
        por medio de terceros los productos y/o servicios disponibles en dichos
        sitios enlazados.
      </p>
      ...
      <p>
        Aretsanas de Velas en ningún caso revisará o controlará el contenido de
        otros sitios web, así como tampoco aprueba, examina ni hace propios los
        productos y servicios, contenidos, archivos y cualquier otro material
        existente en los referidos sitios enlazados.
      </p>

      <p>
        Aretsanas de Velas no asume ninguna responsabilidad por los daños y
        perjuicios que pudieran producirse por el acceso, uso, calidad o licitud
        de los contenidos, comunicaciones, opiniones, productos y servicios de
        los sitios web no gestionados por Aretsanas de Velas y que sean
        enlazados en este Sitio Web. El Usuario o tercero que realice un
        hipervínculo desde una página web de otro, distinto, sitio web al Sitio
        Web de Aretsanas de Velas deberá saber que:
      </p>
      ...
      <p>
        ...
        sobre el Sitio Web de Aretsanas de Velas, ni sobre los Contenidos y/o
        Servicios del mismo.
      </p>
      ...
      <p>
        ...
        autorización expresa de Aretsanas de Velas.
      </p>

      <p>
        El establecimiento del hipervínculo no implicará la existencia de
        relaciones entre Aretsanas de Velas y el titular del sitio web desde el
        cual se realice, ni el conocimiento y aceptación de Aretsanas de Velas
        de los contenidos, servicios y/o actividades ofrecidas en dicho sitio
        web, y viceversa.
      </p>

      <h1>PROPIEDAD INTELECTUAL E INDUSTRIAL</h1>
      <p>
        Aretsanas de Velas por sí o como parte cesionaria, es titular de todos
        los derechos de propiedad intelectual e industrial del Sitio Web, así
        como de los elementos contenidos en el mismo (a título enunciativo y no
      ...
      <p>
        ...
        medio técnico, sin la autorización de Aretsanas de Velas.
      </p>

      <p>
        El Usuario se compromete a respetar los derechos de propiedad
        intelectual e industrial de Aretsanas de Velas. Podrá visualizar los
        elementos del Sitio Web o incluso imprimirlos, copiarlos y almacenarlos
        en el disco duro de su ordenador o en cualquier otro soporte físico
        siempre y cuando sea, exclusivamente, para su uso personal. El Usuario,
        sin embargo, no podrá suprimir, alterar, o manipular cualquier
        dispositivo de protección o sistema de seguridad que estuviera instalado
        en el Sitio Web.
      </p>
      ...
      <p>
        ...
        inmediatamente a Aretsanas de Velas a través de los datos de contacto
      ...
      <p>
        Aretsanas de Velas se reserva la facultad de presentar las acciones
      ...
      <p>
        La relación entre el Usuario y Aretsanas de Velas se regirá por la
      ...
      <p>
        ...
        condiciones de uso online el día 13/04/2026.
      </p>
    </div>
  );
}
